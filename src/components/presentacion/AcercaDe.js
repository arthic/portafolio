	...
	return (
		<div className="contenedor animate__animated animate__fadeIn animate__delay-2s">
			<Contenido className="tarjeta-contenido">
				...
				<br/><br/>Soy un Frontend con inclinaciones a convertirse en Full Stack Developer, me encuentro en busqueda de una oportunidad laboral como desarrollador para continuar consolidando mis conocimientos recien adquiridos en dichas tecnologías, aportar valor a la organización y desarrollar mi carrera profesional.
				</p>
			</Contenido>
		</div>
	)
